      ...
      <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">
            This app is for umpires only. Please contact an administrator if you need access.
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <Routes>
        ...
        <Route path="/league/:leagueId/create-match" element={<MatchCreationPage />} />
        <Route path="/league/:leagueId/match/:matchId/score" element={<ModernScoringPage />} />
